...
$(window).load(function(){
	$(window).stellar({horizontalScrolling:false, hideDistantElements: false});
	...
	$(window).scroll(function () {
			var sl = Math.ceil($(this).scrollTop());
			var hc = $("header .contain").offset().top;
			var sec2H = $(".sec1 .contain").height();
				...
				$('.sec1 .sc').animate({"opacity":1},400,function(){
					$('.sec1 .secondheading').animate({"opacity":1},400,function(){
						$('.sec1 .thirdheading').animate({'opacity':1},400,function(){
							$('.sec1 .man').animate({'opacity':1,'left':0+'px'},400,function(){
